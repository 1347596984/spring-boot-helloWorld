        ...
        <form class="layui-form form" id="form" action="" method="post">
            <table class="layui-table">
                <tr>
                    ...
                    <td style="width: 40%;">
                        <input type="text" class="layui-input queryItem" name="name" id="name" maxlength="10">
                    </td>
                    <td style="width: 10%;" class="query">年龄</td>
                    <td style="width: 40%;">
                        <input type="text" class="layui-input queryItem" name="age"  maxlength="3"
                ...
                <tr>
                    ...
                    <td >
                        <input type="text" onblur="validateEMail(this);" class="layui-input queryItem" name="email" id="email" maxlength="30">
                    </td>
                    <td  class="query">出生日期<span class="note">*</span></td>
                    <td >
                        <input type="text" style="width: 86%;" class="layui-input" readonly="readonly"
